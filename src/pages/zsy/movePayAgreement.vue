  ...
  <div class="bankAgreement">
    ...
    <div class="textWrapper">
      <div class="text">
        ...
        <br><p class="fontBlack">特别提醒：鉴于您（以下或称“特约商户”）向浙江网商银行股份有限公司（以下简称“我行”）申请开通移动支付收单服务，我行诚恳地建议您：在我行网站、软件客户端或我行认可的其他网站、软件客户端（简称“收单平台”）确认接受本协议之前，应事先了解清楚并充分理解本协议条款的全部内容。一旦您在任何收单平台点击接受或以本协议，即意味着您愿意向我行申请开通移动支付收单服务，并已阅读、充分理解和接受本协议所有条款，同意接受本协议约束。</p>
        <p class="fontBlack">为充分维护您的合法权益，我行特提醒您特别关注本协议条款中的加粗及加下划线部分。如您无法准确理解或不同意本协议任一条款，请勿继续之后的流程；如有疑问，烦请致电我行客服电话【95188-3】。</p>
        <div class="content">
          <p class="fontBlack fontSz">第一部分   服务与费用</p><br>
          <div class="xyImg"><img src="../../common/image/xy.png" alt="" class="xyImgs" @click="showImg"></div>
          <img class="preview-img" v-for="(item, index) in list" :src="item.src" height="100" @click="$preview.open(index, list)" v-show="false">
          <br><p class="fontBlack fontSz">第二部分    基本条款</p>
          <br><p>经友好协商，本着自愿、互利和共赢的合作原则，根据《中华人民共和国合同法》等法律法规及收单业务的相关规定，就我行向特约商户提供移动支付收单服务达成以下协议，以资共同遵守。</p>
          ...
          <p>1.1用户：使用移动支付（包括支付宝、微信等支付工具，下同）在特约商户处购买商品或服务并支付相应货款的付款人。</p>
          <p>1.2移动支付收单服务：指用户在特约商户处购买商品或服务时通过移动支付方式支付款项，由我行向特约商户提供资金结算的服务。</p>
